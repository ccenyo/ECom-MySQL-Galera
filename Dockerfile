...
FROM ubuntu:12.04
MAINTAINER Severalnines AB <info@severalnines.com>
...
RUN LC_ALL=en_US.utf8 DEBIAN_FRONTEND=noninteractive apt-get --yes --force-yes install nano wget psmisc libdbi-perl libdbd-mysql-perl libwrap0 pe
rl libaio1 mysql-client percona-xtrabackup libssl0.9.8 libssl1.0.0 rsync netcat
